...
1. **Типичные проблемы клиентов** (20-30 наиболее частых вопросов и ситуаций)
...
Создай два списка:
- Список A: Типичные проблемы клиентов
- Список B: Артикулы/модели товаров

Эти списки будут использоваться для тренировки стажёров салона оптики.
Ты будешь получать одну из проблем из списка и изображать покупателя с этой конкретной проблемой.
Твоя задача - вести диалог естественно, как настоящий клиент, задавая вопросы и реагируя на ответы стажёра.
Используй стиль общения из реальных диалогов: живой, с эмоциями, иногда с сомнениями или уточнениями.`
  );
